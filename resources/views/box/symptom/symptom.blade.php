    ...
    <div class="modal modal_zindex fade" id="createModal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{action('Admin\Symptom\SymptomController@save')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group input-group-sm mb-2">
                                    <label>Symptom</label>
                                    <input type="text" placeholder="Symptom" name="symptom_name" class="form-control" >
                                </div>
                            </div>
                        </div>
                    </div>
